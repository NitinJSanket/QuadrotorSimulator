...
for k=1:NumLines
    if(strcmp(CurrLine{k}(1), 'boundary'))
        ...
        if(strcmp(CurrLine{k}(1), 'block'))
            ...
            Block(a, 7) = str2double(CurrLine{k}(8)); % Color R Channel
            Block(a, 8) = str2double(CurrLine{k}(9)); % Color G Channel
            Block(a, 9) = str2double(CurrLine{k}{10}); % Color B Channel
            ...
            BlockOrg(a, 7) = str2double(CurrLine{k}(8)); % Color R Channel
            BlockOrg(a, 8) = str2double(CurrLine{k}(9)); % Color G Channel
            BlockOrg(a, 9) = str2double(CurrLine{k}{10}); % Color B Channel
            a = a+1;
        end
    end
end
